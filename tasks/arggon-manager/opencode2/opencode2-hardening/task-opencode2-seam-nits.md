...
### handoff 2026-09-18 @Arggon (session: ses_f4a99e6d3ffesjcQ33UNQ9wgBc) — next: Review draft PR #346 (F1 anchor + F2 plan/propose docs), re-run gates, merge to opencode2 — item stays in_progress for auto-done.
- branch: feat/task-opencode2-seam-nits
- open questions: none
