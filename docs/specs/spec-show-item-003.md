...
status: implemented
created: 2026-09-14
adr: docs/adr/0006-token-context-efficiency.md
---
...
docs/json-output.md), exit non-zero.
...
- [ ] Docs: README command list + example; docs/json-output.md `show` section + SHOW_FAILED (additive)
