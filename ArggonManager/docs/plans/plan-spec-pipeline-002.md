...
spec: ArggonManager/docs/specs/spec-spec-pipeline-002.md
status: implemented
created: 2026-09-11
---
...
Derivado del spec `ArggonManager/docs/specs/spec-spec-pipeline-002.md`.
...
- README (`### arggon spec`), `ArggonManager/docs/json-output.md` (enum + payload), una línea
  en `ArggonManager/docs/agents.md` §Specs and plans apuntando a `arggon spec validate/new`.
