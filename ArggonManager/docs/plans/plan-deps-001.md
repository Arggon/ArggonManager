...
spec: ArggonManager/docs/specs/spec-deps-001.md
status: implemented
created: 2026-09-11
---
...
Derivado del spec `ArggonManager/docs/specs/spec-deps-001.md`. Cada tarea tiene criterio de
...
- `WorkItem.depends_on: string[]` en `ArggonManager/docs/json-output.md`.
...
- `ArggonManager/docs/convention.md` sección v3 (campos, validación, migración) + json-output.
