...
spec: ArggonManager/docs/specs/spec-opencode-seam-010.md
status: implemented
created: 2026-09-18
---
...
Derived from `ArggonManager/docs/specs/spec-opencode-seam-010.md`. Each task carries a
...
- `ArggonManager/docs/agents.md` §Reference integrations: list the OpenCode seam as part of
