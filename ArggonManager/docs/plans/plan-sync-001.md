...
spec: ArggonManager/docs/specs/spec-sync-001.md
status: implemented
created: 2026-09-10
---
...
Derivado del spec `ArggonManager/docs/specs/spec-sync-001.md`. Cada tarea tiene criterio de aceptación verificable y enlaces al spec.
