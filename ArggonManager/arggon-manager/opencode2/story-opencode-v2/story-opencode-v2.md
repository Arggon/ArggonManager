...
- [x] W0 — ADR 0010 Proposed, spec + plan merged, tracker restructured under
...
- [x] W2 — vendored plugin: MCP auto-registration, failure isolation, smoke
...
- [x] W7 — dogfood + release: this repo self-hosts the surface, upgrade path
      proven, docs current, spec/plan flipped `implemented`, program PR merged
      (task-opencode2-dogfood).
- [x] Essence guardrails verified end-to-end: CLI/MCP identical with the plugin
