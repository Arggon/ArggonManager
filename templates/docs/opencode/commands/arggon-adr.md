...
The process and the minimum template live in `docs/engineering.md` §ADR process
...
1. Confirm the decision qualifies (stack/package layout, identity model,
   ...
   do not need an ADR.
2. Number it 4-digit monotonic under `docs/adr/NNNN-short-title.md` and keep the
   template sections: Status / Date / Deciders, Context, Decision,
   Consequences, Alternatives considered.
3. Ground it in the exploration or spec that produced it (`docs/explorations/`)
